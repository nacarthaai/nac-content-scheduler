...
class StockEngine:
    ...
    def fetch(self, prompt, orientation: str = "landscape", min_duration: int = 5, variant: str = "") -> Path:
        # Pexels needs short search terms — extract first 3 meaningful words from the prompt
